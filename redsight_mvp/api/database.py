...
class Finding(db.Model):
    ...
    evidence = db.relationship('Evidence', backref='finding', lazy=True, cascade="all, delete-orphan")
...
class Evidence(db.Model):
    ...
    finding_id = db.Column(UUID(as_uuid=True), db.ForeignKey('findings.id'), nullable=False)
